  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col font-body-md antialiased">
      ...
      <main className="flex-grow w-full flex flex-col items-center pb-24">
        {/* Article Container - Lebar dibatasi agar panjang baris nyaman dibaca (60-80 karakter) */}
        <article className="w-full max-w-4xl px-6 md:px-8 mt-12 md:mt-16 mx-auto">
          ...
          <header className="mb-12 border-b border-outline-variant pb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-on-surface-variant text-sm md:text-base font-medium">
          ...
          {/* ─── ISI ARTIKEL ─── */}
          {/* Mengandalkan 'prose md:prose-lg' bawaan Tailwind agar proporsi heading dan paragraf terhitung otomatis secara matematis */}
          <div className="prose md:prose-lg max-w-none text-on-surface-variant leading-relaxed text-justify [&_h2]:text-left [&_h3]:text-left">
            <p>
            ...
            <h2 className="text-on-surface mt-12 mb-6">
            ...
            <h3 className="text-on-surface mt-10 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">psychology</span>
            ...
            <div className="not-prose mt-6 bg-surface-variant/30 rounded-xl p-5 md:p-6 space-y-4 text-sm md:text-base border border-outline-variant">
              <div>
                <strong className="text-primary block mb-2">Contoh perilaku:</strong>
              ...
              <div>
                <strong className="text-error block mb-2">Dampak:</strong>
                <ul className="list-disc pl-5 space-y-1.5">
              ...
              <div>
                <strong className="text-secondary block mb-2">Cara mengatasinya:</strong>
                <ul className="list-disc pl-5 space-y-1.5">
            ...
            <h3 className="text-on-surface mt-12 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">mood</span>
            ...
            <h3 className="text-on-surface mt-12 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">update</span>
            ...
            <h3 className="text-on-surface mt-12 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">sick</span>
            ...
            <h3 className="text-on-surface mt-12 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">gavel</span>
            ...
            <h3 className="text-on-surface mt-12 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">sync_problem</span>
            ...
            <h2 className="text-on-surface mt-14 mb-6">
            ...
            <h3 className="text-on-surface mt-10 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">brightness_4</span>
            ...
            <h3 className="text-on-surface mt-10 mb-4 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-[28px] md:text-[32px]">battery_alert</span>
          ...
          <div className="mt-16 pt-10 border-t border-outline-variant flex justify-center">
            <Link
              ...
              className="inline-flex items-center gap-3 bg-primary text-on-primary px-10 py-5 rounded-2xl font-bold text-lg md:text-xl hover:bg-primary/90 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1"
            >
              <span className="material-symbols-outlined text-[24px] md:text-[28px]">assignment</span>
