...
const DIMENSIONS = [
  {
    icon: 'visibility',
    title: 'Salience',
    subtitle: 'Dominasi Pikiran',
    desc: 'Seberapa sering pikiran kamu dikuasai oleh video pendek, bahkan saat sedang melakukan aktivitas lain.',
    color: '#00685f',
  ...
  },
  {
    ...
    subtitle: 'Pelarian Emosi',
    desc: 'Apakah kamu mengandalkan video pendek sebagai pelarian utama saat merasa bosan, sedih, atau stres.',
    color: '#6750A4',
  ...
  },
  {
    ...
    subtitle: 'Hilang Kendali',
    desc: 'Kesulitan menghentikan tontonan meskipun kamu sudah berniat untuk berhenti sejak tadi.',
    color: '#B3261E',
  ...
  },
  {
    ...
    title: 'Withdrawal',
    subtitle: 'Perasaan Tidak Nyaman',
    desc: 'Rasa gelisah, sedih, atau cemas yang muncul ketika tidak bisa mengakses video pendek.',
    color: '#E8710A',
  ...
  },
  {
    ...
    subtitle: 'Dampak Negatif',
    desc: 'Gangguan nyata terhadap produktivitas, kualitas tidur, atau hubungan sosial akibat kebiasaan menonton.',
    color: '#7D5260',
    bg: 'rgba(125, 82, 96, 0.08)',
  },
  {
    icon: 'psychology_alt',
    title: 'Withdrawal (Anxiety)',
    subtitle: 'Kecemasan',
    desc: 'Siklus FOMO dan kecemasan yang hanya bisa ditenangkan dengan membuka aplikasi kembali.',
    color: '#386A20',
